...
public class PhanSo {
    ...
    public void print(){
        ...
        if(mau1 == 0)
            ...
            if(tu1 == 0)
                System.out.printf("Phân số thứ 1 vừa nhập là: 0/%d = 0\n",mau1);
            else
                System.out.printf("Phân số thứ 1 vừa nhập là: %d/%d\n",tu1,mau1);
        }
        ...
        if(mau2 == 0)
            ...
            if(tu2 == 0)
                ...
                System.out.printf("Phân số thứ 2 vừa nhập là: %d/%d\n",tu2,mau2);
        }
    }
